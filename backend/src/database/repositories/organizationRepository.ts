...
import { FieldTranslatorFactory, OpensearchQueryParser } from '@gitmesh/opensearch'
import { Error404, PageData } from '@gitmesh/common'
import {
  FeatureFlag,
...
class OrganizationRepository {
  ...
  static async findAndCountAllOpensearch(
    ...
    const translatedRows = response.body.hits.hits.map((o) =>
      translator.translateObjectToGitmesh(o._source),
    )
