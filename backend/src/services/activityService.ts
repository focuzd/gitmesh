...
import { LoggerBase, logExecutionTime } from '@gitmesh/logging'
import { WorkflowIdReusePolicy } from '@gitmesh/temporal'
import { FeatureFlag, PlatformType, SyncMode } from '@gitmesh/types'
...
export default class ActivityService extends LoggerBase {
  ...
  async createWithMember(data, fireGitmeshWebhooks: boolean = true) {
