  ...
  >
    <template #header>
      <div>
        ...
        <h4 class="text-lg font-medium mt-1 text-gray-200">
          Add automation
        </h4>
      </div>
    </template>
...
.filter-options {
  .el-collapse {
    ...
    .el-collapse-item__header {
      @apply text-gray-300 bg-gray-50 text-xs flex flex-row-reverse justify-end leading-tight h-6 p-0 font-medium border-none;
