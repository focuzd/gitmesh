  ...
  <div class="app-list-table !bg-black">
    ...
    <div v-else>
      ...
      <app-empty-state-cta
        ...
        icon="ri-contacts-line"
        title="No community contacts yet"
        description="Contacts may take time to appear for first time."
              ...
              >
                ...
                <template #default="scope">
                  <router-link
                    ...
                    class="block"
                  >
                    <div data-qa="member-oss-contributions" class="text-zinc-200 text-sm member-oss-contributions">
                      {{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <template #content>
                          <span>Send email
                            <i
                              v-if="email"
                              class="ri-external-link-line text-zinc-200"
                            /></span>
                        </template>
                        <div @click.prevent>
                          <a
                      ...
                      >
                        <template #reference>
                          <span
                            class="badge--interactive hover:text-zinc-100"
                  ...
                  >
                    <div class="h-full flex items-center justify-center w-full">
                      <button
                        ...
                        class="el-dropdown-link btn p-1.5 rounder-md hover:bg-zinc-800 text-zinc-400"
                        type="button"
