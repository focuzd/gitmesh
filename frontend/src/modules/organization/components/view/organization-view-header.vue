<template>
  <div class="organization-view-header panel relative">
    <div class="flex justify-between">
      <div class="flex items-center">
        ...
        <div>
          ...
          <div
            class="text-sm text-zinc-400 flex items-center"
          >
            <div
    ...
    <div
      class="py-6 border-b border-zinc-700 mb-4"
    >
      ...
      <div
        ...
        ref="descriptionRef"
        class="mt-2 text-sm text-zinc-400 line-clamp-4"
    ...
    <div class="grid grid-rows-2 grid-flow-col gap-4">
      <div>
        <p class="text-zinc-200 font-medium text-2xs">
          # of contacts
        </p>
        <p class="mt-1 text-zinc-200 text-xs">
          {{
