<template>
  <div ref="wrapper" class="report-view-page overflow-auto">
    ...
    <div v-else>
      <div
        ref="header"
        class="mb-4 sticky top-0 inset-x-0 z-30 bg-zinc-900"
        :class="{
          'border-b border-zinc-700': !isHeaderOnTop,
          'border-b border-zinc-700': isHeaderOnTop,
        }"
      >
        <div
      ...
      <div
        v-if="tenantId"
        class="w-full text-zinc-400 text-xs flex items-center leading-none"
      >
        <div
        ...
        >
          <div class="flex items-center">
            <a
              ...
              class="text-zinc-400 hover:text-brand-500"
              target="_blank"
            ...
            <a
              ...
              class="text-zinc-400 hover:text-brand-500 mr-8"
              target="_blank"
              rel="noopener noreferrer"
            >
              Imprint
      ...
      >
        <div class="text-zinc-300 text-2xs">
          Powered by
        </div>
