    ...
    <div class="flex items-center flex-wrap">
      <template v-for="(filter, fi) of filterList" :key="filter">
        ...
        >
          <div
            v-if="fi > 0"
            class="border text-xs border-zinc-700 rounded-md shadow justify-center
          h-8 flex font-medium items-center py-1 px-2 bg-zinc-900 cursor-pointer hover:bg-zinc-800 transition mr-3 mb-4"
