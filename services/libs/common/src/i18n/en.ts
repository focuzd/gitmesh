const en = {
  ...
  errors: {
    ...
    signals: {
      urlRequiredWhenUpserting: 'URL field is mandatory when upserting signalsContent',
      contentNotFound: 'Signals content not found. Action will not be created.',
      ...
      notOnboarded: 'Signals is not set up yet.',
